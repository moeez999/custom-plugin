...
<div id="my_lessons_tutor_profile_modal">
  ...
  <div class="my_lessons_tutor_profile_modal_body">
    <h3>What my students say <i class="fas fa-info-circle my_lessons_tutor_profile_modal_info"></i></h3>
    ...
    <div class="my_lessons_tutor_profile_modal_reviews">
      ...
      <div class="review-item">
        <div class="review-header">
          <img src="/mnt/data/81942d39-a228-484b-9bc6-5f9933a92aaf.png" alt="Marcos" class="review-avatar">
          <div>
...
<hr>
      ...
      <div class="review-item">
        <div class="review-header">
          <img src="https://i.imgur.com/placeholder.jpg" alt="Alejandro" class="review-avatar">
          <div>
            <div class="review-name">Alejandro</div>
      ...
      <div class="review-item">
        <div class="review-header">
          <img src="https://i.imgur.com/placeholder2.jpg" alt="Blas" class="review-avatar">
          <div>
            <div class="review-name">Blas</div>
            <div class="review-date">December 21, 2024</div>
          </div>
        </div>
        <div class="review-stars">★★★★★</div>
        <div class="review-text">
