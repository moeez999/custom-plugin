    ...
    <div id="find_group_profile_container" class="max-w-[1144px]">
        ...
        <div id="my_lessons_tutor_profile_left">
          ...
          <div class="" style="padding: 31px; border: 0.5px solid #00000033;
            ...
            <div id="group_schedule_calendar" class="mt-3 d-flex" style="justify-content: space-between;  font-family: 'Figtree', sans-serif; font-weight: 700">
              <button type="button" class="select-none w-47 h-70" data-key="sat">
                <div class="text-[15px] text-[#6B6E76]">sat</div>
                <div class="mt-1 w-9 h-9 mx-auto rounded-full flex items-center justify-center inactive_day_label label">16</div>
              </button>
            
              <button type="button" class="select-none w-47 h-70" data-key="sun">
                <div class="text-[15px] text-[#6B6E76]">sun</div>
                <div class="mt-1 w-9 h-9 mx-auto rounded-full flex items-center justify-center inactive_day_label label">17</div>
              </button>
            
              <button type="button" class="select-none w-47 h-70" data-key="mon">
                <div class="text-[15px] text-[#121117] font-semibold">mon</div>
                <div class="mt-1 w-9 h-9 mx-auto rounded-full flex items-center justify-center inactive_day_label active_day_label label">18</div>
              </button>
            
              <button type="button" class="select-none w-47 h-70" data-key="tue">
                <div class="text-[15px] text-[#6B6E76]">tue</div>
                <div class="mt-1 w-9 h-9 mx-auto rounded-full flex items-center justify-center inactive_day_label label">19</div>
              </button>
          
              <button type="button" class="select-none w-47 h-70" data-key="wed">
                <div class="text-[15px] text-[#6B6E76]">wed</div>
                <div class="mt-1 w-9 h-9 mx-auto rounded-full flex items-center justify-center inactive_day_label label">20</div>
              </button>
            
              <button type="button" class="select-none w-47 h-70" data-key="thu">
                <div class="text-[15px] text-[#6B6E76]">thu</div>
                <div class="mt-1 w-9 h-9 mx-auto rounded-full flex items-center justify-center inactive_day_label label">21</div>
              </button>
            
              <button type="button" class="select-none w-47 h-70" data-key="fri">
                <div class="text-[15px] text-[#6B6E76]">fri</div>
                <div class="mt-1 w-9 h-9 mx-auto rounded-full flex items-center justify-center inactive_day_label label">22</div>
              </button>
            </div>
            ...
            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div class="find_groups_book_trail_lesson_step2_box rounded-xl p-3">
                ...
                <div id="find_groups_book_trail_lesson_step2_date_x" class="text-[16px] font-semibold">Monday, March 18</div>
              </div>
              <div class="find_groups_book_trail_lesson_step2_box rounded-xl p-3">
                <div class="text-[14px] text-[#6B6E76] mb-1">Time</div>
                <div id="find_groups_book_trail_lesson_step2_time_x" class="text-[16px] font-semibold">8 PM</div>
              </div>
            </div>
          ...
          <div class="text-[12px] text-[#6B6E76]">
            ...
            <button id="direct-book-btn" class="button-continue mt-4 w-full h-[48px] text-[18px] rounded-[10px] font-semibold bg-[var(--fgda-peach)] text-white border-2 border-black">
              Continue
            </button>
          </div>
        ...
        <div id="my_lessons_tutor_profile_right" style="border-radius: 12px;">
          <div class="my_lessons_tutor_profile_card">
            <div class="my_lessons_tutor_profile_card_media">
              ...
              <div class="my_lessons_tutor_profile_card_play" id="video-pay-button">
