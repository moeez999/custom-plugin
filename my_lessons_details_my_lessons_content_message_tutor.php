...
<!-- Panel -->
<div class="my_lessons_details_my_lessons_content_message_tutor_panel fixed bottom-6 right-6 z-[2147483647] hidden
  ...
  <!-- Today pill -->
  <div class="px-5 py-3">
    <div class="my_lessons_details_my_lessons_content_message_tutor_today
                mx-auto w-fit bg-gray-100 text-gray-700 text-sm font-medium rounded-md px-4 py-1.5">
      Today
    </div>
  </div>
  ...
  <div class="my_lessons_details_my_lessons_content_message_tutor_feed
              my_lessons_details_my_lessons_content_message_tutor_scroll flex-1 overflow-y-auto px-5 pb-2 space-y-6"
    ...
    <div class="flex items-start gap-3">
      ...
      <div>
        ...
        <div class="mt-1 text-[15px] leading-relaxed text-gray-800" data-ml_msgtext>
...
$(function(){
  ...
  $my_lessons_details_my_lessons_content_message_tutor_document.on(
    'click',
    '.my_lessons_details_my_lessons_content_message_tutor_panel .my_lessons_details_my_lessons_content_message_tutor_close, .my_lessons_details_my_lessons_content_message_tutor_panel .my_lessons_details_my_lessons_content_message_tutor_back',
    function(){
      $(this).closest('.my_lessons_details_my_lessons_content_message_tutor_panel').addClass('hidden');
    }
  );
